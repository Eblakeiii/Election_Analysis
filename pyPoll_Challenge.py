...
with open(file_to_save, "w") as txt_file:
    ...
    for county in votes_by_county:
        ...
        county_votes_pct = float(county_votes) / float(total_votes) * 100

        # 6d: Print the county results to the terminal.
        county_results = (f"{county}: {county_votes_pct:.2f}% ({county_votes:,})\n")
        ...
        if county_votes > largest_vote_count:
            largest_vote_count = county_votes
            largest_turnout = county

    # 7: Print the county with the largest turnout to the terminal.
    print(
        f"----------------------------------------------\n"
        f"The county with the largest turnout: {largest_turnout}\n"
        f"----------------------------------------------\n\n")
